...
from transnas_api.lib.models.net_ops.cell_ops import *
from transnas_api.lib.models.net_infer.cell_micro import ResNetBasicblock
...
if __name__ == '__main__':
    # net = SegmentationDecoder((512, 16, 16), (256, 256), target_num_channel=17).cuda()
